# Colores custom segun pywall o colores cargados en p10k-colors.zsh

[[ -f ~/.config/theme/colors/p10k-colors.zsh ]] && source ~/.config/theme/colors/p10k-colors.zsh
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%F{${ICON_BG}}╭─%f'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%F{${ICON_BG}}%f'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{${ICON_BG}}╰─%f%F{${ICON_BG}}$%f'
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=$ICON_FG
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=$ICON_BG 
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=$DIR_BG

  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=$DIR_BG
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=$DIR_BG

  typeset -g POWERLEVEL9K_DIR_VISUAL_IDENTIFIER_COLOR=$DIR_FG

  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='󰣚'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$DIR_FG
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$ICON_BG
